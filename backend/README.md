...
## Project Structure
    ...
    ├── tst_tc3071_vfegyqis_67032  # Django project configurations
...
1. Clone this repo and `cd tst_tc3071_vfegyqis_67032`
...
2. Clone this repo and `cd tst_tc3071_vfegyqis_67032`
